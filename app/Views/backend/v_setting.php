  ...
  <div class="card card-primary shadow-lg">
    <div class="card-header">
      ...
      <!-- <div class="card-tools">
        <a class="btn btn-tool" data-card-widget="maximize"><i class="fas fa-plus"></i></button>
      </div> -->
    </div>
    ...
    <?php
        ...
        echo '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><i class="icon fas fa-check"></i>';
